      ...
      <div class="max-w-md w-full">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
          ...
          <form @submit.prevent="handleLogin" class="space-y-6">
            ...
            <button 
              type="submit" 
              class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors-normal" 
